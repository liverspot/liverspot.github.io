...
<h2 id='meld-score'><a href='#meld-score'>MELD Score</a></h2>
...
<h2 id='meld-calculation'><a href='#meld-calculation'>MELD Calculation</a></h2>
<p>
...
<h4 id='other-components'><a href='#other-components'>Other Components</a></h4>
<p>
...
<h3 id='meld-sum'><a href='#meld-sum'>MELD Sum</a></h3>
...
<h2 id='example-meld-score'><a href='#example-meld-score'>Example MELD Score</a></h2>
...
<h3 id='example-components'><a href='#example-components'>Example Components</a></h3>
...
<h4 id='example-normalization'><a href='#example-normalization'>Example Normalization</a></h4>
<p>Normalization of these values so they have similar characteristics produces this:</p>
<figure class="w-richtext-align-center w-richtext-figure-type-image">
    <div>
        <img alt="normalized_values" src="/images/2024-02-19-meld-score-explanation/normalized_values.png"/>
    </div>
</figure>
<p>With this version everything is within a plausibly similar range, has similar physical impacts, and badness is in the same direction (positive is bad).</p>
<h4 id='example-contribution'><a href='#example-contribution'>Example Contribution</a></h4>
...
<h4 id='example-sum'><a href='#example-sum'>Example Sum</a></h4>
...
<h3 id='example-scores'><a href='#example-scores'>Example Scores</a></h3>
